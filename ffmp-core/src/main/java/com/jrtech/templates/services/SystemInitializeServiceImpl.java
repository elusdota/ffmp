...
//		gaRepository.save(root);
        ...
        third.setParent(second);
        second.getChildren().add(third);
        third = new GrantedAuthorityImpl("维保负责人审核");
        ...
        third.setParent(second);
        second.getChildren().add(third);
        second = new GrantedAuthorityImpl("备件库存管理");
        second.setSrc("warehouse/inventory");
        second.setIcons("fa-ship");
        second.setParent(root);
        root.getChildren().add(second);
        third = new GrantedAuthorityImpl("备件库存查询");
        third.setIcons("fa-search");
        third.setParent(second);
        second.getChildren().add(third);
        second = new GrantedAuthorityImpl("设备库存管理");
        second.setSrc("warehouse/equipmentInventory");
        second.setIcons("fa-ship");
        second.setParent(root);
        root.getChildren().add(second);
        third = new GrantedAuthorityImpl("设备库存查询");
        third.setIcons("fa-search");
        third.setParent(second);
        second.getChildren().add(third);
        ...
        root = new GrantedAuthorityImpl("工具管理");
        root.setIcons("fa-sitemap");
        second = new GrantedAuthorityImpl("工具库存管理");
        second.setSrc("tools/toolsInventory");
        second.setIcons("fa-warning ");
        second.setParent(root);
        root.getChildren().add(second);
        third = new GrantedAuthorityImpl("工具库存查询");
        third.setIcons("fa-plus");
        third.setParent(second);
        second.getChildren().add(third);
        second = new GrantedAuthorityImpl("工具借出");
        second.setSrc("tools/dispatch");
        second.setIcons("fa-warning ");
        second.setParent(root);
        root.getChildren().add(second);
        third = new GrantedAuthorityImpl("查询");
        ...
        third.setParent(second);
        second.getChildren().add(third);
        third = new GrantedAuthorityImpl("创建借出");
        third.setIcons("fa-plus");
        third.setParent(second);
        second.getChildren().add(third);
        third = new GrantedAuthorityImpl("查看");
        third.setIcons("fa-plus");
        third.setParent(second);
        second.getChildren().add(third);
        second = new GrantedAuthorityImpl("工具归还");
        second.setSrc("tools/inbounds");
        second.setIcons("fa-warning ");
        second.setParent(root);
        root.getChildren().add(second);
        third = new GrantedAuthorityImpl("创建归还");
        third.setIcons("fa-plus");
        third.setParent(second);
        second.getChildren().add(third);
        third = new GrantedAuthorityImpl("查看");
...
//        accountRepository.save(account);
    ...
    private void createTaskDefinition() {
        ...
        flowchartStepses1.add(new FlowchartSteps("维保负责人审核", "cond3", "condition","cond1","op"));
