  ...
  <section class="content">
    <div class="row">
      <div class="box-footer">
        <sec:authorize access="@userDetailsUtils.isAuthorized('/工具管理/工具库存管理/工具库存查询')">
          <form class="form-horizontal" id="inboundsForm">
            <div class="form-group col-md-6">
              <label for="name" class="col-lg-6 control-label">名称：</label>
...
<script src="<c:url value='/js/tools/toolsInventory.js'/>"></script>
