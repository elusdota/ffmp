...
<section class="content-header">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">工具归还</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="row">
            <sec:authorize access="@userDetailsUtils.isAuthorized('/工具管理/工具归还/查询')">
            ...
            <div class="box-footer">
                <sec:authorize access="@userDetailsUtils.isAuthorized('/工具管理/工具归还/创建归还')">
                    <button type="button" id="createDispatch" class="btn btn-default pull-left">创建归还</button>
                </sec:authorize>
                <sec:authorize access="@userDetailsUtils.isAuthorized('/工具管理/工具归还/查看')">
...
<script src="<c:url value='/js/tools/inbounds.js'/>"></script>
