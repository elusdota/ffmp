...
<section class="content-header">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">报损单</li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    <div class="row">
      <sec:authorize access="@userDetailsUtils.isAuthorized('/仓库管理/报损单/报损单查询')">
      ...
      <div class="box-footer">
        <sec:authorize access="@userDetailsUtils.isAuthorized('/仓库管理/报损单/创建报损单')">
          <button type="button" id="createLoss" class="btn btn-default pull-left">创建报损单</button>
        </sec:authorize>
        <sec:authorize access="@userDetailsUtils.isAuthorized('/仓库管理/报损单/查看报损单详情')">
          <button type="button" id="viewLoss" class="btn btn-default pull-left">查看报损单详情</button>
        </sec:authorize>
        <sec:authorize access="@userDetailsUtils.isAuthorized('/仓库管理/报损单/报损单查询')">
          <button type="button" id="queryLoss" class="btn btn-default pull-right">查询</button>
        </sec:authorize>
      </div>
      <table id="lossTable"
  ...
  <!-- 模态框（Model） -->
  <div class="modal fade" id="lossModel" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <form class="form-horizontal" id="lossForm">
...
<script src="<c:url value='/js/inventory/loss.js'/>"></script>
