  ...
  <section class="content">
    <div class="row">
      <div class="box-footer">
        <sec:authorize access="@userDetailsUtils.isAuthorized('/仓库管理/设备库存管理/设备库存查询')">
          <form class="form-horizontal" id="inboundsForm">
            <div class="form-group col-md-6">
              <label for="name" class="col-lg-6 control-label">设备名称：</label>
...
<script src="<c:url value='/js/inventory/equipmentInventory.js'/>"></script>
