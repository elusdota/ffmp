  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <sec:authorize access="@userDetailsUtils.isAuthorized('/基础信息管理/生产厂家信息管理/创建生产厂家')">
        <button type="button" id="createOrganization" class="btn btn-default">创建生产厂家</button>
      </sec:authorize>
      <sec:authorize access="@userDetailsUtils.isAuthorized('/基础信息管理/生产厂家信息管理/修改生产厂家')">
        <button type="button" id="updateOrganization" class="btn btn-default">修改生产厂家</button>
      </sec:authorize>
      <sec:authorize access="@userDetailsUtils.isAuthorized('/基础信息管理/生产厂家信息管理/删除生产厂家')">
        <button type="button" id="updateOrganization" class="btn btn-default">删除生产厂家</button>
      </sec:authorize>
    </div>
    <div class="box-body">
