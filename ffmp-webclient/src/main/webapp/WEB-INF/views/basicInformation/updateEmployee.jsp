  ...
  <section class="content">
    <div class="row">
      <form class="form-horizontal" id="saveForm">
        ...
        <div class="form-group col-md-4">
          <label for="work" class="col-lg-6 control-label">是否离职：</label>

          <div class="col-lg-6 checkbox">
            <select class="col-lg-1 combobox form-control" name="work" id="work" disabled="true">
