  ...
  <section class="content">
    <div class="row">
      <div class="box-footer">
        <sec:authorize access="@userDetailsUtils.isAuthorized('/基础信息管理/职工管理/创建职工')">
          <button type="button" id="createEmployee" class="btn btn-default pull-left">创建职工</button>
        </sec:authorize>
        <sec:authorize access="@userDetailsUtils.isAuthorized('/基础信息管理/职工管理/修改职工')">
          <button type="button" id="updateEmployee" class="btn btn-default pull-left">修改职工</button>
        </sec:authorize>
...
<script src="<c:url value='/js/basicInfo/employee.js'/>"></script>
