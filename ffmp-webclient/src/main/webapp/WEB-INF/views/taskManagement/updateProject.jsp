    ...
    <div class="row">
      <form class="form-horizontal" id="saveForm">
        ...
        <div class="form-group col-md-4">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control" readonly id="customer" name="customer" placeholder="选择客户名称"
                   required="required">
          </div>
        </div>
        <div class="form-group col-md-4">
...
<script src="<c:url value='/js/taskManagement/updateProject.js'/>"></script>
