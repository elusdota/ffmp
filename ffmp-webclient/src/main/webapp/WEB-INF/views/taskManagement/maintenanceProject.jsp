    ...
    <section class="content">
        <div class="row">
            <div class="box-footer">
                ...
                <sec:authorize access="@userDetailsUtils.isAuthorized('/维管工作管理/项目信息管理/修改项目')">
                    <button type="button" id="updateProject" class="btn btn-default pull-left">修改项目</button>
                </sec:authorize>
                <sec:authorize access="@userDetailsUtils.isAuthorized('/维管工作管理/项目信息管理/终止项目')">
                    <button type="button" id="endProject" class="btn btn-default pull-left">终止项目</button>
                </sec:authorize>
                <sec:authorize access="@userDetailsUtils.isAuthorized('/维管工作管理/项目信息管理/定期检查设备')">
