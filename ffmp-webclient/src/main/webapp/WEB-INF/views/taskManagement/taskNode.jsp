    ...
    <div class="row">
      <form class="form-horizontal" id="searchForm">
        ...
        <div class="form-group col-md-4">
          <label for="name" class="col-lg-6 control-label">节点名称：</label>
        ...
        <div class="form-group col-md-4">
          <label for="delegate" class="col-lg-6 control-label">执行人：</label>

          <div class="col-lg-6">
            <input type="text" class="form-control" id="delegate" name="delegate" placeholder="执行人"
                   required="required">
          </div>
        </div>
        <div class="form-group col-md-4">
          <label for="dueDate" class="col-lg-6 control-label">执行时间：</label>

          <div class="col-lg-6">
            <input type="text" class="form-control" id="dueDate" name="dueDate" placeholder="执行时间"
                   required="required">
          </div>
        </div>
      </form>
...
<script src="<c:url value='/js/taskManagement/taskNode.js'/>"></script>
